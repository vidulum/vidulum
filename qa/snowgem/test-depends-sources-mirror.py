...
# This script tests that the package mirror at https://vidulum.app/depends-sources/
# contains all of the packages required to build this version of Vidulum.
#
# This script assumes you've just built Vidulum, and that as a result of that
...
MIRROR_URL_DIR="https://vidulum.app/depends-sources/"
