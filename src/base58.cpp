...
// Explicit instantiations for libvidulum::PaymentAddress
template bool CZCEncoding<libvidulum::PaymentAddress,
                          CChainParams::ZCPAYMENT_ADDRRESS,
                          libvidulum::SerializedPaymentAddressSize>::Set(const libvidulum::PaymentAddress& addr);
template libvidulum::PaymentAddress CZCEncoding<libvidulum::PaymentAddress,
                                              CChainParams::ZCPAYMENT_ADDRRESS,
                                              libvidulum::SerializedPaymentAddressSize>::Get() const;

// Explicit instantiations for libvidulum::ViewingKey
template bool CZCEncoding<libvidulum::ViewingKey,
                          CChainParams::ZCVIEWING_KEY,
                          libvidulum::SerializedViewingKeySize>::Set(const libvidulum::ViewingKey& vk);
template libvidulum::ViewingKey CZCEncoding<libvidulum::ViewingKey,
                                          CChainParams::ZCVIEWING_KEY,
                                          libvidulum::SerializedViewingKeySize>::Get() const;

// Explicit instantiations for libvidulum::SpendingKey
template bool CZCEncoding<libvidulum::SpendingKey,
                          CChainParams::ZCSPENDING_KEY,
                          libvidulum::SerializedSpendingKeySize>::Set(const libvidulum::SpendingKey& sk);
template libvidulum::SpendingKey CZCEncoding<libvidulum::SpendingKey,
                                           CChainParams::ZCSPENDING_KEY,
                                           libvidulum::SerializedSpendingKeySize>::Get() const;
