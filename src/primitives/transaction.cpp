...
JSDescription::JSDescription(ZCJoinSplit& params,
            ...
            const boost::array<libvidulum::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libvidulum::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
            bool computeProof,
...
{
    boost::array<libvidulum::Note, ZC_NUM_JS_OUTPUTS> notes;
...
bool JSDescription::Verify(
    ZCJoinSplit& params,
    libvidulum::ProofVerifier& verifier,
    const uint256& pubKeyHash
) const {
