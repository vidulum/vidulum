...
{
    return "\n" +
           FormatParagraph(strprintf(_("In order to ensure you are adequately protecting your privacy when using Vidulum, please email <%s>."),
                                     "support@vidulum.org")) + "\n";
}
...
std::string LicenseInfo()
{
    return "\n" +
           ...
           FormatParagraph(strprintf(_("Copyright (C) %i The Vidulum developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
