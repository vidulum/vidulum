...
class CZCPaymentAddress : public CZCEncoding<libvidulum::PaymentAddress, CChainParams::ZCPAYMENT_ADDRRESS, libvidulum::SerializedPaymentAddressSize> {
protected:
...
public:
    ...
    CZCPaymentAddress(const libvidulum::PaymentAddress& addr) { Set(addr); }
};

class CZCViewingKey : public CZCEncoding<libvidulum::ViewingKey, CChainParams::ZCVIEWING_KEY, libvidulum::SerializedViewingKeySize> {
protected:
...
public:
    ...
    CZCViewingKey(const libvidulum::ViewingKey& vk) { Set(vk); }
};

class CZCSpendingKey : public CZCEncoding<libvidulum::SpendingKey, CChainParams::ZCSPENDING_KEY, libvidulum::SerializedSpendingKeySize> {
protected:
...
public:
    ...
    CZCSpendingKey(const libvidulum::SpendingKey& addr) { Set(addr); }
};
