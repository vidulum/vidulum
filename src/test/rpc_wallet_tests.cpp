...
BOOST_AUTO_TEST_CASE(rpc_wallet_z_validateaddress)
{
    ...
    std::set<libvidulum::PaymentAddress> addrs;
...
BOOST_AUTO_TEST_CASE(rpc_wallet_z_importwallet)
{
    ...
    auto testSpendingKey = libvidulum::SpendingKey::random();
    ...
    std::string format_str = "# Wallet dump created by Vidulum v0.11.2.0.z8-9155cc6-dirty (2016-08-11 11:37:00 -0700)\n"
...
BOOST_AUTO_TEST_CASE(rpc_wallet_z_importexport)
{
    ...
    auto sk = libvidulum::SpendingKey::random();
