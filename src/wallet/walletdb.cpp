...
bool CWalletDB::WriteCryptedZKey(const libvidulum::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libvidulum::PaymentAddress& addr, const libvidulum::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
...
bool CWalletDB::WriteViewingKey(const libvidulum::ViewingKey &vk)
{
    nWalletDBUpdated++;
    return Write(std::make_pair(std::string("vkey"), vk), '1');
}

bool CWalletDB::EraseViewingKey(const libvidulum::ViewingKey &vk)
{
    nWalletDBUpdated++;
             ...
             CWalletScanState &wss, string& strType, string& strErr)
{
    try {
        ...
        {
            libvidulum::PaymentAddress addr;
            ssKey >> addr;
        ...
        else if (strType == "czkey")
        {
            ...
            uint256 rkValue;
            ssValue >> rkValue;
            libvidulum::ReceivingKey rk(rkValue);
