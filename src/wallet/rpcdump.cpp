    ...
    while (file.good()) {
        ...
        if (fImportZKeys) {
            try {
                ...
                libvidulum::SpendingKey key = spendingkey.Get();
                libvidulum::PaymentAddress addr = key.address();
                ...
                // Not a valid spending key, so carry on and see if it's a vidulum style address.
            }
        }
...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"vidulumaddress\"\n"
            "\nReveals the private key corresponding to 'vidulumaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"vidulumaddress\"   (string, required) The vidulum address for the private key\n"
            "\nResult:\n"
