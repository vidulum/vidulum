...
} // end namespace `libvidulum`

typedef libvidulum::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libvidulum::SHA256Compress> ZCIncrementalMerkleTree;
typedef libvidulum::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvidulum::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libvidulum::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libvidulum::SHA256Compress> ZCIncrementalWitness;
typedef libvidulum::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libvidulum::SHA256Compress> ZCTestingIncrementalWitness;
